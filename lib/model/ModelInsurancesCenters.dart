class ModelInsurancesCenters {
  ...
  factory ModelInsurancesCenters.fromJson(Map<String, dynamic> json) {
    return ModelInsurancesCenters(
      ...
      committee: _committee(json['committee']) as dynamic,
    );
  }
